...
# Kaggle 필터 적용된 URL로 이동 (csv, 24-12-09 당시 Highly-voted: LLM Fine-Tuning)
# url = "https://www.kaggle.com/datasets?fileType=csv&feedbackIds=16"
# Kaggle 필터 적용된 URL로 이동 (csv, 24-12-09 당시 Highly-voted: Research)
# url = "https://www.kaggle.com/datasets?fileType=csv&feedbackIds=9"
# Kaggle 필터 적용된 URL로 이동 (csv, 24-12-09 당시 Highly-voted: Well-documented)
url = "https://www.kaggle.com/datasets?fileType=csv&feedbackIds=11"
...
# 저장 경로와 파일명 설정
output_folder = "D:/kaggle/Kaggle_crawling/kaggle_datasets/filtered_datasets"
output_file = os.path.join(output_folder, "Well-documented.json")  # 특수 문자 제거
